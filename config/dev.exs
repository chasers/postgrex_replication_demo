...
config :replication_demo, ReplicationDemoWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "eNWOUECUbW+oVMaa97JLq7WSrwah3piPnMhKH6y8UOx0e9aLhbyeSNOJZN+XT3Y7",
  watchers: [
...
config :replication_demo, ReplicationDemoWeb.Endpoint,
  live_reload: [
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/replication_demo_web/(live|views)/.*(ex)$",
      ~r"lib/replication_demo_web/templates/.*(eex)$"
    ]
  ]
